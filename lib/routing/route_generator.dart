...
import 'package:workmanager/pages/auth/forgot_password/forgot_password_page.dart';
import 'package:workmanager/pages/auth/reset_password/reset_password_page.dart';
import 'package:workmanager/pages/detail_task/detail_task_page.dart';
import 'package:workmanager/pages/home/home_page.dart';
import 'package:workmanager/pages/list_user_form/list_user_form_page.dart';
import 'package:workmanager/pages/new_task/new_task_page.dart';
  ...
  Route<dynamic> onGenerateRoute(RouteSettings setting) {
    ...
    switch (setting.name) {
      ...
      case AppRoutes.SUCCESSFUL:
        return page(child: const SuccessfulScreen());
