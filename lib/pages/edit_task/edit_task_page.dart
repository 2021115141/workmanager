...
class EditTaskState extends BaseState<EditTaskPage, EditTaskViewModel> {
    ...
    return StreamBuilder<List<ProjectModel>?>(
      ...
      builder: (context, snapshot) {
        ...
        if (oldProject == null) {
          ...
          if (taskdropValue.isNotEmpty) {
            dropValue = taskdropValue.first;
            oldProject = taskdropValue.first;
          }
        }
        return InForm(
          value: dropValue,
  ...
  void editTaskClick(TaskModel oldtask) async {
    ...
    if (formKey.currentState!.validate() &&
        ...
        dueDateValue != null &&
        dueTimeValue != null) {
      dueDateValue = DateTime(dueDateValue!.year, dueDateValue!.month,
