...
import 'package:workmanager/util/ads/adid.dart';
import 'package:workmanager/util/ui/common_widget/quick_note_card.dart';
...
class DetailTaskState extends BaseState<DetailTaskPage, DetailTaskViewModel> {
  ...
  Widget build(BuildContext context) {
    InterstitialAd.load(
        ...
        adUnitId: InterAdHelper.interadunitid,
  ...
  Widget buildBody(TaskModel task) {
    return Column(
      children: [
        ...
        showComment ? buildCommentForm() : const SizedBox(),
        showComment ? buildListComment() : const SizedBox(),
        buildCompletedButton(task.completed, press: () {
          getVm().completedTask(task.id);
          interstitialAd!.show;
        }),
